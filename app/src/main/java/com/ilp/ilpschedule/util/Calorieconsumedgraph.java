...
public class Calorieconsumedgraph extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calorieconsumedgraph);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Calorieconsumedgraph.this,CalorieConsumed.class);
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Calorieconsumedgraph.this,ChartView.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Calorieconsumedgraph.this,DaysviseCalorie.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Calorieconsumedgraph.this,HeartRateChart.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        dist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Calorieconsumedgraph.this, DistanceView.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Calorieconsumedgraph.this, android.R.layout.simple_spinner_dropdown_item, calender);
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(Calorieconsumedgraph.this, android.R.layout.simple_spinner_dropdown_item, activity);
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        if (flag.equalsIgnoreCase("week")) {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                valueSet1.add(vi);
                android.util.Log.d("valuess", "" + valueSet1.add(vi) + CalorieConsumed.calorie[25 + i]);

            }
        } else
        {
            if (CalorieConsumed.reference.equalsIgnoreCase("month")) {
                for (int i = 0; i < 12; i++) {
            ...
            else
            {
                for (int i = 0; i < 30; i++) {
                    ...
                    BarEntry vi = new BarEntry(CalorieConsumed.calorie[i+2],i);
                    valueSet1.add(vi);
                }
            }
