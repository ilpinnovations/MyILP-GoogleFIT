...
public class DistanceWeekView extends AppCompatActivity {
...
//
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DistanceWeekView.this, CalorieConsumed.class);
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DistanceWeekView.this, Daysvise.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DistanceWeekView.this,DaysviseCalorie.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(DistanceWeekView.this,HeartRateChart.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(DistanceWeekView.this,android.R.layout.simple_spinner_dropdown_item,calender);
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                else if(position==1)
                {
                    ...
                    Intent intent=new Intent(DistanceWeekView.this,DistanceView.class);
                    startActivity(intent);
                    // StepCounter stepcounter=new StepCounter();
        ...
        String[] activity={
                "Distance","Steps","Calorie Burned","Heart Rate"
        };
        ArrayAdapter<String> adapter2=new ArrayAdapter<String>(DistanceWeekView.this,android.R.layout.simple_spinner_dropdown_item,activity);
        ...
        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                {
                    Intent intent=new Intent(DistanceWeekView.this,ChartView.class);
                    startActivity(intent);
                }
                else if(position==2)
                {
                    Intent intent=new Intent(DistanceWeekView.this,Calorieconsumedgraph.class);
                    startActivity(intent);
                }
                else if(position==3)
                {
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        if(FitnessActivity.reference.equalsIgnoreCase("day")) {
            for (int i = 0; i < 7; i++) {
                ...
                BarEntry vi = new BarEntry((float)(FitnessActivity.steps[i + 24] * 0.0004707355), i);
                valueSet1.add(vi);
            }
        }
            ...
            for (int i = 0; i < 7; i++){
                BarEntry vi = new BarEntry((float) (FitnessActivity.steps[25                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          +i]*0.0004707355),i);
                valueSet1.add(vi);
        ...
        BarDataSet barDataSet1 = new BarDataSet(valueSet1, "Distance in miles");
        barDataSet1.setColor(Color.rgb(53,181,56));
